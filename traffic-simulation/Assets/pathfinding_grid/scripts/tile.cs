...
public class tile : MonoBehaviour
{
    ...
    public bool bouchon = false;
    public bool isDestination = false;
    public GameObject magasin;
    private float weigth = 1;
    public bool isGasStation = false;
    ...
    private void Update()
    {
            ...
            if (isDestination)
            {
                im.color = new Color(destinationColor.r,destinationColor.g,destinationColor.b);
            }
            ...
            if (db_chars.Count > 1) bouchon = true;
    }
